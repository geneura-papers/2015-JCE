...
detección de estos dispositivos 
% Antonio - lo de inteligentes nunca me ha gustado...yo lo quitaría
% Antares - Ale, ahora son tontos :P
...
Su interfaz de conexión es USB, pero lamentablemente la antena está integrada dentro del chipset por lo que no es posible cambiarla de forma estándar. Sin embargo, el alcance teórico alcance los 100 metros, con uno efectivo de 25-30 metros, lo cual es un radio de acción más que suficiente para el propósito.
...
% Antares - xD
 \textit{usbcore.autosuspend=-1} en el módulo USBCORE del kernel del SO que indica que puede que no puede suspender los dispositivos USB. Normalmente la opción incorpora un intervalo de tiempo que indica cuando tiene que estar sin uso un dispositivo para considerarlo para la suspensión.
