...
Cada sistema de captación (Bluetooth y Wifi) tiene un funcionamiento similar compuesto por tres elementos:
% Antonio - hay 4 elementos. XD
...
% Yo pondría algo como 'al seguir el estándar definido por el IEEE'
